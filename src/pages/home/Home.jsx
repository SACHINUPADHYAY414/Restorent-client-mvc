        ...
        <Container>
          <Row className="justify-content-center mt-4 mt-md-0">
            <Col
              xs={12}
              lg={8}
              className="hero-text mb-5 mb-lg-0 text-center text-lg-start px-3"
            >
              ...
              <div className="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-start gap-3 text-center text-md-start mobile-text-small">
            ...
            <Col xs={12} lg={4} className="px-0 px-lg-3">
              <div className="reservation-form p-4 rounded-4 bg-dark bg-opacity-75">
                <h3 className="fw-bold mb-4 text-center">Make a Reservation</h3>
